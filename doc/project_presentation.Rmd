...
![*Figure 1: Flowchart showing the pipeline for the project.*](pictures/pipeline.png){width=800px}
...
>>>>>>> 11555357d096c7afa9bf8ad7fd277cd552118f7e
```
...
knitr::include_graphics("../results/06_confusion_matrix_linear_model.png")
knitr::include_graphics("../results/06_confusion_matrix_log_model.png")
```
